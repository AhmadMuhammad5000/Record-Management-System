      ...
      <div class="container1">
        <div class="sub_container">
            <div class="bg bg-success">
               <h3 class="text-light"> Add Staff </h3>
            </div>
            
               <form id="form" action="php_add_staff.php" method="POST" class="form-control" autocomplete="off" enctype="multipart/form-data">   
                  <div class="flex1">
                      <div class="div">
                 ...
                 <div class="flex1">
                     ...
                     <div class="div">
                         <input type="submit" id="add" name="add" class="form-control btn btn-success" value="Add Staff">
                     </div>
