        ...
        <div class="sub_container">
            <div class="bg bg-success">
               <h3 class="text-light"> Edit Record </h3>
                ...
                <form id="form" action="php_edit_lab_record.php" method="POST" class="form-control" autocomplete="off" enctype="multipart/form-data">   
                  <div class="flex1">
                      <div class="div">
                      ...
                      <div class="div"> 
                           ...
                           <input type="text" name="result" class="form-control" placeholder="Record Test"></Textarea>
                       </div>
                  </div>
                  ...
                  <div class="flex1">
                       <div class="div"> 
                           ...
                           <input type="text" name="address" class="form-control" placeholder="Address"></Textarea>
                       </div>

                       <div class="div"> 
                           <label for="name"> Phone </label><br>
                           <input type="text" name="phone" class="form-control" placeholder="phone"></Textarea>
                       </div>
                 </div>
