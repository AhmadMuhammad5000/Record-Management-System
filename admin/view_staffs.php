    ...
    <div class="subheader">
        <table class="table">
            ...
            <?php
               ...
               $sql = $conn->prepare("SELECT * FROM staffs ORDER BY id DESC");
               $sql->execute();
               $rs = $sql->get_result();
...
?>
           <div class="content bg-danger">
                <tr class="bg-success text-light">
                   ...
                   <td><?php echo $date; ?></td>
                   <td><a class="text-primary" href="edit_staff.php?unique=<?php echo $unique; ?>"><i class="fa fa-edit text-dark"></i></a></td>
                   <td><a class="text-danger" href="delete_staff.php?unique=<?php echo $unique; ?>"><i class="fa fa-trash text-dark"></i></a></td>
               </tr>
...
// closing while loop
     ...
     echo "<script>No Staffs are found</script>";
 }
 ?>
