...
<div class="container-fluid">
    <div class="options">
       ...
       <ul class="select" id="select">
          ...
          <li><a href="recordlogin.php">Record Unit Staff</a></li>
      </ul>
    </div>

    <!-- Login form for an admin -->
    <div id="form" class="form">
        <form method="post" action="php_recordlogin.php" autocomplete="off" class="form-control">     
        <h3> Record Unit </h3>
            <div class="div">
