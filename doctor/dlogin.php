...
<div class="container-fluid">
    ...
    <button onclick="loginAs()" id="login">Login as: </button>
       <ul class="select" id="select">
          ...
          <li><a href="dlogin.php">Doctor</a></li>
    ...
    <!-- Login form for an doctor -->
    <div id="form" class="form">
        <form method="post" action="php_dlogin.php" autocomplete="off" class="form-control">     
        <h3> Doctor </h3>
            <div class="div">
