...
<div class="container-fluid">
    ...
    <button onclick="loginAs()" id="login">Login as: </button>
       <ul class="select" id="select">
          ...
          <li><a href="../nurse/nurselogin.php">Nurse</a></li>
          <li><a href="pharmlogin.php">Pharmacy Staff</a></li>
    ...
    <!-- Login form for pharmacy department -->
    <div id="form" class="form">
        <form method="post" action="php_pharmlogin.php" autocomplete="off" class="form-control">     
        <h3> Pharmacy </h3>
            <div class="div">
